...
export default function CamsPortfolio() {
  ...
  const handleFetchPortfolio = () => {
    navigate('/onboarding/cams-portfolio')
  }
  ...
  return (
    <div className={pageStyle}>
      ...
      <div className='w-full'>
        <SubHeader
          title={"Cams portfolio fetch"}
          subTitle={"We need your PAN, email & phone to fetch your MF portfolio from Cams."}
        />
      </div>
